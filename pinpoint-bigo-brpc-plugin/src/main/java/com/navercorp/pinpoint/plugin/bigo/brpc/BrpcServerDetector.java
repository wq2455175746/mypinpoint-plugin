 ...
 * @author Jinkai.Ma
 */
public final class BrpcServerDetector {

    private static final String DEFAULT_EXPECTED_MAIN_CLASS = "com.baidu.brpc.interceptor.ServerInvokeInterceptor";

    private List<String> expectedMainClasses;

    public BrpcServerDetector(List<String> expectedMainClasses) {
